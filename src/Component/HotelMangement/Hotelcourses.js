...
<Link  to="/hmdiploma" class="btn baarts-bt mb-4   " data-aos="fade-up">Read more</Link>
</div>
          </div>
          <div className='col-md-4   mt-2 '>
<div class="card cad-col">
...
<Link  to="/bbatourism"class="btn bt mb-4   " data-aos="fade-up">Read more</Link>
</div>
          </div>
          <div className='col-md-4   mt-2 '>
<div class="card cad-col">
...
<Link  to="/bachelorhm"class="btn bt mb-4   " data-aos="fade-up">Read more</Link>
</div>
          </div>

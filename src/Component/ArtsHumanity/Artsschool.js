...
const Artsschool = () => {
  return <div>
     <div class="container-fluid artsimage1  ">
 <div class="container">
    <div class="row">
       <div class="col-sm-12 mt-4 ">
   <center> <h2 class="text-white  display-3 nursingsmt mt-5 " data-aos="fade-down" >School Of Arts and Humanity</h2></center>
...
<div className='container-fluid mt-5  '>
  <div className='container p-5 '>
    ...
    <h2 className='mb-2 mt-2 nursingh'><span className='nursing-span'>Best Arts and Humanity </span> Science College in Uttarkashi</h2>
